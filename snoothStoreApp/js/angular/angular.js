...
function jqLiteBuildFragment(html, context) {
  ...
  if (jqLiteIsTextNode(html)) {
    ...
    MSApp.execUnsafeLocalFunction(function() { tmp.innerHTML = wrap[1] + html.replace(XHTML_TAG_REGEXP, "<$1></$2>") + wrap[2]; })
  ...
  MSApp.execUnsafeLocalFunction(function () { fragment.innerHTML = ""; });// Clear inner HTML
  ...
  this.$get = [
    ...
    function wrapTemplate(type, template) {
      ...
      case 'math':
        ...
        MSApp.execUnsafeLocalFunction(function () { wrapper.innerHTML = '<' + type + '>' + template + '</' + type + '>'; });
